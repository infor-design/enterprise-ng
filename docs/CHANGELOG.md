...
- `[Modal]` Merged SohoModalModule into SohoModalDialogModule keeping current API but fixing the memory leaks. `BTHH` ([#XXX](https://github.com/infor-design/enterprise-ng/pull/XXX))
