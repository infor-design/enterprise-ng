...
export const PAGING_COLUMNS: SohoDataGridColumn[] = [
  { id: 'selectionCheckbox', sortable: false, resizable: false, formatter: Soho.Formatters.SelectionCheckbox, align: 'center', exportable: false },
  { id: 'productId',   name: 'Product Id',   field: 'productId',   sortable: false, filterType: 'integer', formatter: Soho.Formatters.Readonly },
  { id: 'productName', name: 'Product Name', field: 'productName', sortable: false, filterType: 'text', filterConditions: ['equals', 'contains'], formatter: Soho.Formatters.Hyperlink },
  { id: 'activity',    name: 'Activity',     field: 'activity',    sortable: false, filterType: 'text',    },
  { id: 'quantity',    name: 'Quantity',     field: 'quantity',    sortable: false,                        },
  ...
  { id: 'productId',   name: 'Product Id 1',   field: 'productId',   sortable: false, filterType: 'integer', formatter: Soho.Formatters.Readonly },
  { id: 'productName', name: 'Product Name 1', field: 'productName', sortable: false, filterType: 'text', filterConditions: ['equals', 'contains'], formatter: Soho.Formatters.Hyperlink },
  { id: 'activity',    name: 'Activity 1',     field: 'activity',    sortable: false, filterType: 'text',    },
  { id: 'quantity',    name: 'Quantity 1',     field: 'quantity',    sortable: false,                        },
  { id: 'price',       name: 'Price 1',        field: 'price',       sortable: false, filterType: 'decimal', formatter: Soho.Formatters.Decimal },
  { id: 'orderDate',   name: 'Order Date 1',   field: 'orderDate',   sortable: false, filterType: 'date',    formatter: Soho.Formatters.Date, dateFormat: 'M/d/yyyy' }
];
/* tslint:enable */
