...
export class DataGridPagingServiceDemoService extends SohoDataGridService {
  ...
  init() {
    this.columns = [
      { id: 'productId', name: 'Product Id', field: 'productId', width: 140, formatter: Formatters.Readonly },
      { id: 'productName', name: 'Product Name', sortable: false, field: 'productName', width: 150, formatter: Formatters.Hyperlink },
      { id: 'activity', hidden: true, name: 'Activity', field: 'activity', width: 125 },
      { id: 'quantity', name: 'Quantity', field: 'quantity', width: 125 },
      { id: 'price', name: 'Price', field: 'price', width: 125, formatter: Formatters.Decimal },
      { id: 'orderDate', name: 'Order Date', field: 'orderDate', formatter: Formatters.Date, dateFormat: 'M/d/yyyy' }
    ];
