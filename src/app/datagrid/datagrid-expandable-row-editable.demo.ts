...
import { PAGING_COLUMNS, PAGING_DATA } from './datagrid-paging-data-edit1';
...
@Component({
  selector: 'app-datagrid-expandable-row-editable-demo',
  templateUrl: 'datagrid-expandable-row-editable.demo.html',
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class DataGridExpandableRowEditableDemoComponent implements AfterViewChecked, OnInit {
