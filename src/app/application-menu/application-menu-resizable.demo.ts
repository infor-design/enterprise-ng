import {
  ...
  @Component({
    ...
    selector: 'application-menu-resizable-demo',
    templateUrl: 'application-menu-resizable.demo.html',
    changeDetection: ChangeDetectionStrategy.OnPush
  })
  export class ApplicationMenuResizableDemoComponent implements AfterViewInit, OnInit {
