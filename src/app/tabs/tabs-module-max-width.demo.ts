...
export class TabsModuleMaxWidthDemoComponent implements OnInit {
  ...
  @ViewChild('longTitle', { read: SohoTabsComponent, static: true })
  sohoTabsComponent?: SohoTabsComponent;

  @ViewChild('shortTitle', { read: SohoTabsComponent, static: true })
  sohoTabsShort?: SohoTabsComponent;
  ...
  addLongTab() {
    ...
    const tabId = `long-order-${counter}`;
    const options = {
      name: `CRS852 SMS Data. Create from Sales Statistics. Tab - ${counter}`,
      isDismissible: true,
  ...
  ngOnInit() {
    if (this.sohoTabsComponent) {
      this.sohoTabsComponent.moduleTabs = true;
    }
    if (this.sohoTabsShort) {
      this.sohoTabsShort.moduleTabs = true;
    }
  }

  public longData: Array<any> = [
    {
      id: 'long-order-1',
      title: 'CRS852 SMS Data. Create from Sales Statistics. Tab 1',
    ...
    {
      id: 'long-order-2',
      title: 'CRS852 SMS Data. Create from Sales Statistics. Tab 2',
    ...
    {
      id: 'long-order-3',
      title: 'CRS852 SMS Data. Create from Sales Statistics. Tab 3',
    ...
    {
      id: 'long-order-4',
      title: 'CRS852 SMS Data. Create from Sales Statistics. Tab 4',
    ...
    {
      id: 'long-order-5',
      title: 'CRS852 SMS Data. Create from Sales Statistics. Tab 5',
    ...
    {
      id: 'long-order-6',
      title: 'CRS852 SMS Data. Create from Sales Statistics. Tab 6',
    ...
    {
      id: 'long-order-7',
      title: 'CRS852 SMS Data. Create from Sales Statistics. Tab 7',
      body: 'You can define different named build configurations for your project, such as stage and production, with different defaults. Each named configuration can have defaults for any of the options that apply to the various builder targets, such as build, serve, and test. The Angular CLI build, serve, and test commands can then replace files with appropriate versions for your intended target environment.', // eslint-disable-line
    },
    {
      id: 'long-order-8',
      title: 'CRS852 SMS Data. Create from Sales Statistics. Tab 8',
      body: 'You can define different named build configurations for your project, such as stage and production, with different defaults. Each named configuration can have defaults for any of the options that apply to the various builder targets, such as build, serve, and test. The Angular CLI build, serve, and test commands can then replace files with appropriate versions for your intended target environment.', // eslint-disable-line
    },
  ];
}
