...
export class DataGridDemoService extends DataGridService {
  ...
  constructor() {
    ...
    this.columns.push({
      id: 'productDesc', name: 'Product Desc', sortable: false, field: 'productName',
    ...
    this.columns.push({
      id: 'orderDate', name: 'Order Date', field: 'orderDate', formatter: Formatters.DateTime,
      dateFormat: 'yy/MM/dd'
    });
    ...
    this.columns.push({
      id: 'alert', name: 'Alert', field: 'quantity', formatter: Formatters.Alert,
    ...
    this.data.push({
      id: 1, productId: 2142201, productName: 'Compressor',
    ...
    this.data.push({
      id: 2, productId: 2241202, productName: 'Different Compressor',
    ...
    this.data.push({
      id: 3, productId: 2342203, productName: 'Compressor',
