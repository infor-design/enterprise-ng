...
export class DataGridDemoService extends DataGridService {
    ...
    constructor() {
        ...
        this.columns.push({
            id: 'drillDown', name: 'Drill In', field: '', formatter: Formatters.Drilldown, cssClass: 'l-center-text',
            click: function (e: any, args: any) { console.log('clicked', args); }
        });
        this.columns.push({ id: 'productId', hidden: true, name: 'Product Id', field: 'productId', formatter: Formatters.Readonly });
        this.columns.push({ id: 'productDesc', name: 'Product Desc', sortable: false, field: 'productName',
        formatter: Formatters.Hyperlink, click: function (e: any, args: any) { console.log('link was clicked', args); } });
        ...
        this.columns.push({ id: 'orderDate', name: 'Order Date', field: 'orderDate', formatter: Formatters.DateTime,
         dateFormat: 'yy/MM/dd' });

        // {date: 'datetime'
        this.columns.push({ id: 'status', name: 'Status', field: 'status', formatter: Formatters.Text });
        this.columns.push({ id: 'alert', name: 'Alert', field: 'quantity', formatter: Formatters.Alert,
        ...
        this.columns.push({ id: '', name: 'Actions', field: '',
        formatter: Formatters.Actions, menuId: 'grid-actions-menu', selected: function (e: any, a: any) { console.log(e, a); } });
        ...
        this.data.push({ id: 1, productId: 2142201, productName: 'Compressor',
        activity: 'Assemble Paint', quantity: 1, price: 210.99, status: 'OK',
        orderDate: new Date(2014, 12, 8), action: 'Action', ordered: 1, setting: { optionOne: 'One', optionTwo: 'One' } });
        this.data.push({ id: 2, productId: 2241202, productName: 'Different Compressor',
        activity: 'Inspect and Repair', quantity: 2, price: 210.99, status: '', orderDate: new Date(2015, 7, 3), action: 'On Hold', ordered: true, setting: { optionOne: 'One', optionTwo: 'One' } });
        this.data.push({ id: 3, productId: 2342203, productName: 'Compressor',
        activity: 'Inspect and Repair', quantity: 1, price: 120.99, status: null, orderDate: new Date(2014, 6, 3), action: 'Action',
