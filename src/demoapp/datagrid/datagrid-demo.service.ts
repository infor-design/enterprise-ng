...
/* tslint:disable */
    ...
    this.columns.push({ id: 'productDesc', name: 'Product Desc', sortable: false, field: 'productName', formatter: Formatters.Hyperlink, click(e: any, args: any) { console.log('link was clicked', args); } });
    ...
    this.columns.push({ id: 'orderDate', width: 300, name: 'Order Date', field: 'orderDate', formatter: Formatters.DateTime, dateFormat: 'yy/MM/dd'});
