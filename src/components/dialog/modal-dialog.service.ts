...
import { SohoModalDialogRef } from './modal-dialog.ref';
/**
...
export class SohoModalDialogService {
   ...
   * @param options
   */
  open<T>(component: ComponentType<T>, options: SohoModalDialogOptions): SohoModalDialogRef<T> {
  ...
  //  */
  // private _createOverlay(dialogConfig: SohoModelDialogOptions): OverlayRef {
