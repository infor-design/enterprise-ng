...
export class SohoWizardComponent implements AfterViewInit, AfterContentInit, OnDestroy {
   ...
   *
   */
  @ContentChild(SohoWizardPagesComponent, /* TODO: add static flag */ {static: false}) pagesContainer: SohoWizardPagesComponent;
   ...
   *
   */
  @ContentChild(SohoWizardHeaderComponent, /* TODO: add static flag */ {static: false}) header: SohoWizardHeaderComponent;
  ...
  ngAfterViewInit() {
    ...
    this.jQueryElement
      .on('beforeactivate', (e: JQuery.TriggeredEvent, tick: SohoWizardTick) => this.onBeforeActivate(tick))
      .on('activated', (e: JQuery.TriggeredEvent, tick: JQuery) => this.onActivated(tick))
      .on('afteractivated', (e: JQuery.TriggeredEvent, tick: JQuery) => this.afteractivated.next({ tick: tick }));
