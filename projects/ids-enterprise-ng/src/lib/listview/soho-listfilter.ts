 ...
 */
function wordStartsWithFilter(text: any, term: any) {
...
export default class ListFilter {
   ...
   */
  init() {
    function setReasonableDefaults(setting: any, limits: any, preset: any) {
   ...
   */
  filter(list: any, term: any, isStrict: any) {
    if (!list) {
      return false;
    }
    ...
    function getObjectPropsAsText(thisItem: any) {
      let text = '';
    ...
    function searchItemIterator(item: any) {
